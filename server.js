...
const commentsRouter_1 = require("./router/commentsRouter");
    ...
    function getUserFromHeader() {
        return __awaiter(this, void 0, void 0, function* () {
            if (opts.req.headers.authorization) {
                const user = yield (0, authUtils_1.verifyJwt)(opts.req.headers.authorization.split(' ')[1]);
                if (!user)
...
const appRouter = router({
    ...
    posts: postRouter_1.postRouter,
    comments: commentsRouter_1.commentsRouter
});
